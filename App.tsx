      ...
      <header className="h-14 bg-surface border-b border-slate-700 flex items-center justify-between px-4 shrink-0 shadow-md z-20">
        ...
        <div className="hidden lg:flex items-center justify-center flex-1 mx-4">
          <div className="flex items-center gap-2.5 px-3.5 py-1 bg-slate-900 border border-indigo-500/30 rounded-full select-none shadow-sm">
            ...
            <span className="text-indigo-200 text-xs font-extrabold tracking-wider uppercase">3107Ver</span>
            <span className="text-[9px] font-mono text-indigo-400 font-black tracking-normal ml-0.5 px-1.5 py-0.5 bg-indigo-950/40 border border-indigo-500/25 rounded uppercase">v3.0</span>
          </div>
        </div>
