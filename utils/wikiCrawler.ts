...
export function isWikiItemLoreValid(title: string, url: string | undefined, originalDomain: string): boolean {
  ...
  const blacklistPhrases = [
    ...
    'wiki-administration', 'behind the scenes', 'real-world details', 'real world details', 'real-world references',
    'báo cáo vi phạm'
  ];
  ...
  const sensitiveWords = [
    'admin', 'moderator', 'moderation', 'policy', 'licensing', 'author', 'creator',
    'community', 'forum', 'blog', 'staff', 'contributor', 'discord', 'social', 'shop', 'store',
    'merchandise', 'advertisement', 'promotional', 'fanart', 'fanfiction', 'fanon', 'fanpic',
    'fan-art', 'fan-fic', 'fan-made', 'fan-fiction', 'gameplay', 'system requirements', 'walkthrough',
